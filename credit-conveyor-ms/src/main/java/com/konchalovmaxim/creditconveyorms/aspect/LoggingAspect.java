...
public class LoggingAspect {
    ...
    @Around("execution(* com.konchalovmaxim.creditconveyorms.service.CreditConveyorService.*(..))")
    public Object aroundAllCreditConveyorServiceMethodsAdvice(
        ...
        logMessage = new StringBuilder("Begin of ");
        logMessage.append(methodSignature.getName());
